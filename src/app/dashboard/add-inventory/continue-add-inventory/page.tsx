...
const Page: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 px-10">
      <div
        className="flex items-center gap-2 text-[28px] font-semibold cursor-pointer mb-8"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1.2 space-y-6">
            ...
            <div>
              ...
              <div className="border p-2 rounded-md text-sm text-gray-700">2016 Nissan Altima</div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-0">
                <div className="flex justify-between py-4 px-4">
                  ...
                  <span className="text-sm text-gray-600">1N4AL3AP8GN321327</span>
                </div>
                <div className="flex justify-between py-4 px-4 bg-[#F5F5F5]">
            ...
            <div className="pt-6">
              <div className=" pt-6">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 text-sm text-gray-700 border border-[#E8E8E8] p-2 rounded-md hover:text-gray-900 transition-colors"
                >
                  <div className="w-5 h-5 rounded-full bg-[#606060] flex p-2  items-center justify-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <div className="flex items-center gap-1 mb-2">
                          ...
                          <div className="w-4 h-4 rounded-full bg-[#344331] flex items-center justify-center">
            ...
            <div className="pt-6">
              <div className="pt-6">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 text-sm text-gray-700 border border-[#E8E8E8] p-2 rounded-md hover:text-gray-900 transition-colors mb-6"
                >
                  <div className="w-5 h-5 rounded-full bg-[#606060] flex p-2 items-center justify-center">
                ...
                <div className="flex gap-3">
                  <Button
                    variant="outline"
                    className="px-8 py-2 text-sm font-medium border border-gray-300 text-gray-700 hover:bg-gray-50"
                  >
                    Cancel
                  </Button>
                  <Button
                    style={{ backgroundColor: "#FFE135" }}
                    className="px-8 py-2 text-sm font-medium text-black hover:opacity-90"
                  >
                    Save
                  </Button>
                </div>
          ...
          <div className="lg:col-span-1 lg:px-20">
            <div className="flex justify-between items-center mb-4">
              ...
              <Button
                style={{ backgroundColor: "#FFE135" }}
                className="text-black hover:opacity-90 font-medium px-4 py-2 text-sm"
              >
                Apply Photo
              </Button>
            </div>
            <div className="text-sm text-gray-500 mb-4">
              Drag & Drop or <span className="text-[#FFF700]">Select Photos</span>
            </div>
            ...
            <div className="bg-[#F5F5F5] p-1 border border-[#E8E8E8] rounded-lg">
              ...
              >
                ...
                <div className="text-sm text-gray-600">Drag & Drop To Upload Or Browse From Pc</div>
              </div>
            </div>
          </div>
        </div>

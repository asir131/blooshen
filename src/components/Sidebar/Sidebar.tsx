...
const Sidebar = () => {
      ...
      children: [
        {
          ...
          label: (
            <Link
              ...
              onClick={closeDrawer}  
            >
              <h1 className="w-2 h-2 p-2 bg-red-500 rounded-full mr-2"></h1>{" "}
              Create Job Post
            </Link>
          ),
        },
        ...
        },
        {
          ...
          label: (
            <Link
              ...
              onClick={closeDrawer}  
            >
              <h1 className="w-2 h-2 p-2 bg-red-500 rounded-full mr-2"></h1> Job
              Quotations
            </Link>
          ),
        },
  ...
  return (
    <div className="w-full">
      ...
      >
        <nav className="h-full p-4 space-y-4 bg-[#FBE9E9]">
          {" "}
